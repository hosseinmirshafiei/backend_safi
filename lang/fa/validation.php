...
return [
    ...
    */
    ...
    "image"            => ":attribute باید فایل image باشد.",
    ...
    */
    'attributes' => [
        ...
        "health"               => "وضعیت جسمانی",
        "family_member"               => "تعداد اعضای خانواده",
        "province"                     => "استان",
        "city"                    => "شهر",
        "religion"              => "دین",
        "date_birth_y"              => "سال تولد",
        "date_birth_m"               => "ماه تولد",
        "date_birth_d"               => "روز تولد",
        "nationality"               => "تابعیت",
        "marriage"               => "سابقه ازدواج",
        "age"                  => "سن",
        "height"               => "ارتفاع",
        "width"               => "عرض",
        "length"               => "طول",
        ...
        "name_discount" => "عنوان تخفیف",
        "percent_discount" => "درصد تخفیف",
        "maximum_discount" => "حداکثر تخفیف",
        "start_discount" =>  "شروع تخفیف",
        "finish_discount" => "پایان تخفیف",
        "sefareshiBase" => "هزینه پایه پست سفارشی",
        "pishtazBase" => "هزینه پایه پست پیشتاز",
        "sefareshiWeight" => "افزایش قیمت پست سفارشی",
        "pishtazWeight" => "افزایش قیمت پست پیشتاز",
        "type"=>"نوع",
