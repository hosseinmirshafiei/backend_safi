...
class PaymentService{
    ...
    public function zarinpal($amount ,$onlinePayment , $type_payment , $wallet_payment)
    {
        $merchentID = Config::get("payment.zarinpal-api-key");
        $sandbox = false;
        $zarinpalGate = false;
        ...
        $payment = [
            'callback_url' => route("payment-call-back" , ["onlinePayment"=>$onlinePayment , "type_payment"=>$type_payment , "wallet_payment"=>$wallet_payment]),
            'amount' => (int)$amount,
    ...
    public function zarinpalVerify($amount , $onlinePayment)
    {
        ...
        $data = ['merchant_id' => Config::get("payment.zarinpal-api-key"), 'authority' => $authority, 'amount' => (int)$amount];
